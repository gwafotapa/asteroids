    ...
    App::new()
        ...
        .add_system_set(
            ConditionSet::new()
                ...
                .with_system(wreckage_update)
                .with_system(wreckage_debris_update)
        ...
        .add_system_set_to_stage(
            ...
            ConditionSet::new()
                ...
                .with_system(wreck_with::<boss::BossCore>)
                .with_system(wreck_with::<boss::BossEdge>)
